...
if __name__ == "__main__":
 filein = sys.argv[1]
 fileout1 = sys.argv[2]  # wikimedia tables
 dirout = sys.argv[3]  # html tables directory
 lines = init_lines(filein)
 tables = tablesfind(lines)
 htmltables(tables)
 # wikimedia format for tables
 outarr = calc_tables_media(tables)
 with codecs.open(fileout1,"w","utf-8") as f:
  for out in outarr:
   f.write(out+'\n')
